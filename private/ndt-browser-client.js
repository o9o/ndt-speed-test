...
// Implements the NDT websocket protocol
// Used from ndt-wrapper-ww.js if WebWorkers are available, otherwise from ndt-wrapper.js directly
// In any case the outer wrapper is ndt-wrapper.js
function NDTjs(server, serverPort, serverProtocol, serverPath, callbacks, updateInterval) {
  this.server = server;
